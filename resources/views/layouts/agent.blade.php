                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <x-nav-link :href="route('agent.properties.index')" :active="request()->routeIs('agent.properties.index')">
                                {{ __('My Listings') }}
                            </x-nav-link>
                            <x-nav-link :href="route('agent.inquiries')" :active="request()->routeIs('agent.inquiries')">
                                {{ __('Inquiries') }}
                            </x-nav-link>
