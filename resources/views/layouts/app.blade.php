                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <x-nav-link :href="route('buyer.favorites')" :active="request()->routeIs('buyer.favorites')">
                                {{ __('Favorites') }}
                            </x-nav-link>
                            <x-nav-link :href="route('buyer.view-history')" :active="request()->routeIs('buyer.view-history')">
                                {{ __('View History') }}
                            </x-nav-link>
